...
4. Theoretical papers or idea sketches(Beyond IGCSE, Alevel, AP or IB syllabus; For physics, encouraged to be mathematical based)
5. Project reports (designs or experiments)
6. Engineering projects
7. Programming or software projects
8. Anything that involves research, experiment or application- if you have any other ideas, please contact [Kyanos](about.qmd), we'll get in touch with you as soon as possible. 
